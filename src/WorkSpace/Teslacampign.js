...
const Teslacampign = () => {
    return (
        <>
            ...
            <div className="teslacampign_main_Wrepper">
                <div className='teslacampign'>
                    <div className="teslacampaign_header">
                        <Workspace />
                    </div>
                                ...
                                <div className='image_color'>
                                    ...
                                    <div className='color_div_pr'>
                                        ...
                                        <div className='hex_code'>
                                            <h6 className='clr_code'>#111111</h6>
                                            <h6 className='clr_code'>#E31937</h6>
                                            <h6 className='clr_code'>#144178</h6>
                                            <h6 className='clr_code'>#d5d5d5</h6>
                                            <h6 className='clr_code'>#ffffff</h6>
                                        </div>
                                    </div>
                                </div>
                                {/*Carousel*/}
