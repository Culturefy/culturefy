                ...
                <div class="col-lg-8">
                                    ...
                                    <div class="design-form-wraper">
                                        <ul class="nav ds-form-tabs" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#info" type="button" aria-selected="true">Info</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#native" type="button" aria-selected="false">native</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#display" type="button" aria-selected="false">Display</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#video" type="button" aria-selected="false">Video</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#audio" type="button" aria-selected="false">Audio</button>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content design">
                                            ...
                                            <div class="tab-pane fade" id="native" role="tabpanel">
                                                <form action="" class="form-design">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                ...
                                                <div className="sub-sec">
                                                    ...
                                                    <div class="a-sm-content-box">
                                                        <div class="sm-head">
                                                            ...
                                                            <button className="btn-generate">Generate Preview</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    {/* <div class="ac-sec possess">
                                <div class="sub-sec">
                                    <div class="main-head">
                                        <h2>Possess</h2>
                                        <span><img src="assets-qa/images/posses-icon.svg" alt=""></span>
                                    </div>
                                    <div class="a-sm-content-box">
                                        <div class="sm-head">
                                            <h3>Review Campaign</h3>
                                        ...
                                        <div class="rev-campaign" style="display: none;">
                                            ...
                                            <div class="slider-wraper">
                                                <div class="slider-camp slick-initialized slick-slider slick-dotted">
                                                    <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 0px; transform: translate3d(0px, 0px, 0px);"><div class="img slick-slide slick-cloned" data-slick-index="-1" id="" aria-hidden="true" tabindex="-1" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-02.png" alt="">
                                                    </div><div class="img slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="0" role="tabpanel" id="slick-slide00" aria-describedby="slick-slide-control00" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-01.png" alt="">
                                                    </div><div class="img slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide01" aria-describedby="slick-slide-control01" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-02.png" alt="">
                                                    </div><div class="img slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide02" aria-describedby="slick-slide-control02" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-01.png" alt="">
                                                    </div><div class="img slick-slide" data-slick-index="3" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide03" aria-describedby="slick-slide-control03" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-02.png" alt="">
                                                    </div><div class="img slick-slide slick-cloned" data-slick-index="4" id="" aria-hidden="true" tabindex="-1" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-01.png" alt="">
                                                    </div><div class="img slick-slide slick-cloned" data-slick-index="5" id="" aria-hidden="true" tabindex="-1" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-02.png" alt="">
                                                    </div><div class="img slick-slide slick-cloned" data-slick-index="6" id="" aria-hidden="true" tabindex="-1" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-01.png" alt="">
                                                    </div><div class="img slick-slide slick-cloned" data-slick-index="7" id="" aria-hidden="true" tabindex="-1" style="width: 0px;">
                                                        <img src="assets-qa/images/slide-02.png" alt="">
                                                    </div></div></div>
                                                ...
                                                <div class="arrows-camp">
                                                    <button class="left-arrow slick-arrow" style=""><i class="fa-solid fa-chevron-left"></i></button>
                                                    <button class="right-arrow slick-arrow" style=""><i class="fa-solid fa-chevron-right"></i></button>
                                                </div>
                                            </div>
