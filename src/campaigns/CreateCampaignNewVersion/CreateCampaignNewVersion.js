...
import PlanOnClick from "./PlanOnClick";
import PositionOnClick from "./PositionOnClick";
import PossessOnClick from "./PossessOnClick";
...
const CreateCampaignNewVersion = () => {
  ...
  const [sortPossess,setSortPossess]=useState()
      ...
      <div className="create_campaignNew_version">
        ...
        <div className="crt_cmpgn_main_pr">
          <div className="crt_cmpgn_aside_left">
            ...
            {show ? <PlanOnClick /> : <Plan />}

            {sortPosition ? <PositionOnClick /> : <Position />}
            {sortPossess ? <PossessOnClick/>: <Possess />}
