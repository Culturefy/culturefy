...
const index = () => {
    const Application_data = [
        {
          sort_name: "AS",
          name: "Annable Summers",
          job_title: "Software Devloper",
          date_submited: "08-08-2022",
          Status: "Interviewed",
        },
        {
          sort_name: "AS",
    ...
    <div className="application_inner_wrapper">
      <div className="job_Applications">
        <div className="add_application_btn">
          <Link to="/recruiting/addapplication">
              ...
              return (
                <>
                  <tr>
                    ...
                    <Link to="/recruiting/applicationdetails">
                        {e.name}
                        </Link>
                        </td>
                    <td>{e.job_title}</td>
                    ...
                    {e.Status == "Interviewed" ? (
                      <td className="application_status">
                        <div
                          className="app_status_div"
                          style={{ backgroundColor: "#f5a41d" }}
                        ></div>
                        {e.Status}
                      </td>
                    ) : null}
