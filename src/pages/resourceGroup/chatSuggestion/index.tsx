        ...
        <div>
            ...
            <div className={Styles.friendListMain}>
                ...
                <div className={Styles.friendList}>
                    <RecognitionUser userImg={inst1Img} username='Kayleigh Bysouth' time='online' />
                    <RecognitionUser userImg={inst2Img} username='Jes Phillips MP' time='1 min' />
                    <RecognitionUser userImg={inst3Img} username='MP Eslam Hisham' time='2 min' />
                    <RecognitionUser userImg={inst1Img} username='Levizja Vetvendos' time='today' />
                    <RecognitionUser userImg={inst2Img} username='Afrim Konjufca' time='online' />
                    <RecognitionUser userImg={inst3Img} username='MP Eslam Hisham' time='2 min' />
                    <RecognitionUser userImg={inst1Img} username='Kayleigh Bysouth' time='online' />
                    <RecognitionUser userImg={inst2Img} username='Jes Phillips MP' time='1 min' />
                    <RecognitionUser userImg={inst3Img} username='MP Eslam Hisham' time='2 min' />
