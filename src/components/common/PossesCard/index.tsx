...
function PossesCard(props: any) {
  ...
  return (
    <div style={{ backgroundColor: props.variant, color: props.text_color }} className={`${Styles[props.size]} ${Styles.possBox} ${Styles[props.variant]} ${props.checked ? Styles.checkedBox : ''} ${props.variant === "#fff" ? Styles.blackBorder : ""}`}>
      <h3>{props.title}</h3>
